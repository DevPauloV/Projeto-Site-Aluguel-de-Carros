...
<form action="cadastroServlet" method="POST">
  ...
  <div class="row justify-content-md-center">  
    <div class="col-md-4 mb-3">
      <label class="form-label label-size">Nome</label>
     
        <input type="text" class="form-control ${erro}" id="nome" placeholder="Nome" name="nome" required>
      </div>
    </div>
  ...
  <div class="row justify-content-md-center">  
    <div class="col-md-4 mb-3">
      <label class="form-label label-size">Telefone</label>
    
        <input type="tel" class="form-control ${erro}" id="telefone" placeholder="Telefone" name="telefone" required>
      </div>
    </div>

  <!--=============================================================================================================== -->
  <div class="container-fliud mb-3" align="center">                      
    <button type="submit" class="btn btn-primary text-light mb-2 mt-3">Cadastrar</button> 
  </div>
</form>
