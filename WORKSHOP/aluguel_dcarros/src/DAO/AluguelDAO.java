	...
	//Metodo de "ATUALIZAÇÂO"
		public void atualizar (alugueis aluguel) {
			try {
				...
				pstmt.setDouble(5, aluguel.getvalor_total());
				pstmt.setInt(6, aluguel.getid_aluguel());
		  ...
		  public alugueis pesquisarPorCodigo(int id_aluguel) {
		        ...
		        try {
		            ...
		            if (rs.next()) {
		                ...
		                aluguelRetorno.setvalor_total(rs.getDouble(5));
		            }
		  ...
		  public List<alugueis> pesquisarTodos() {
			  ...
			  try { 
			      ...
			      while (rs.next()) { 
			          ...
			          alugueis.setvalor_total(rs.getDouble(6));
